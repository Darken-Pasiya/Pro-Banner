echo
echo
echo -e $lb " \e[36m[\e[31m1\e[36m]  \e[32mDevil Art 01 "
echo
echo -e $lb " \e[36m[\e[31m2\e[36m]  \e[32mDevil Art 02 "
echo
echo -e $lb " \e[36m[\e[31m3\e[36m]  \e[32mDevil Art 03 "
echo
echo -e $lb " \e[36m[\e[31m4\e[36m]  \e[32mDevil Art 04 "
echo
echo
echo
echo
...
echo "cd txt" >1.txt
echo "cat devil1.txt | lolcat" >2.txt
echo "cd" >CD.txt
echo "PS1='\$ '" >mark.txt
...
echo "cd Pro-Banner" >pro.txt
echo "cd txt" >1.txt
echo "cat devil2.txt | lolcat" >2.txt
echo "cd" >CD.txt
echo "PS1='\$ '" >mark.txt
rm -rf /data/data/com.termux/files/usr/etc/bash.bashrc
rm -rf /data/data/com.termux/files/usr/etc/zshrc
...
echo "cd Pro-Banner" >pro.txt
echo "cd txt" >1.txt
echo "cat devil3.txt | lolcat" >2.txt
echo "cd" >CD.txt
echo "PS1='\$ '" >mark.txt
rm -rf /data/data/com.termux/files/usr/etc/bash.bashrc
rm -rf /data/data/com.termux/files/usr/etc/zshrc
...
echo "cd Pro-Banner" >pro.txt
echo "cd txt" >1.txt
echo "cat devil4.txt | lolcat" >2.txt
echo "cd" >CD.txt
echo "PS1='\$ '" >mark.txt
rm -rf /data/data/com.termux/files/usr/etc/bash.bashrc
rm -rf /data/data/com.termux/files/usr/etc/zshrc
